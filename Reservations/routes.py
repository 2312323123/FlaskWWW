...
from Reservations.forms import RegistrationForm
...
def rooms(id, selected_floor_number):
    ...
    try:
        ...
        im = Image.open(f"Reservations/static{filename}")
    except:
    ...
    class Floor:
        def __init__(self, building_id, number=0, rooms=None, image_size_x=width,
                     image_size_y=height):  # , image_size_x=781, image_size_y=879):
    ...
    mock_XYs = [XY(157, 112), XY(164, 112), XY(166, 128), XY(216, 122), XY(214, 101), XY(192, 101), XY(193, 92),
                XY(182, 92), XY(182, 100), XY(164, 103), XY(156, 104)]
    mock_room = Room('room1', 1, mock_XYs)
    mock_XYs_1_2 = [XY(169, 135), XY(158, 138), XY(159, 147), XY(169, 148), XY(169, 166), XY(158, 168), XY(160, 176),
                    XY(169, 177), XY(171, 181), XY(220, 177), XY(220, 168), XY(224, 165), XY(224, 147), XY(218, 142),
                    XY(217, 129)]
    mock_room_1_2 = Room('room1_2', 2, mock_XYs_1_2, True)
    mock_floor_1_1 = Floor(1, 1, [mock_room, mock_room_1_2])

    mock_XYs_2 = [XY(169, 135), XY(158, 138), XY(159, 147), XY(169, 148), XY(169, 166), XY(158, 168), XY(160, 176),
                  XY(169, 177), XY(171, 181), XY(220, 177), XY(220, 168), XY(224, 165), XY(224, 147), XY(218, 142),
                  XY(217, 129)]
    mock_room_2 = Room('room2', 2, mock_XYs_2)
    mock_floor_1_2 = Floor(1, 2, [mock_room_2])

    mock_XYs_3 = [XY(226, 317.0500030517578), XY(226, 341.0500030517578), XY(235, 343.0500030517578),
                  XY(235, 370.6666717529297), XY(223, 373.6666717529297), XY(270, 483.6666717529297),
                  XY(334, 621.6666870117188), XY(341, 616.6666870117188), XY(346, 625.6666870117188),
                  XY(538, 585.6666870117188), XY(522, 223), XY(420, 213), XY(420, 220), XY(398, 218.5), XY(397, 211.5),
                  XY(248, 201), XY(249, 297.6666717529297)]
...
def mapa():
    ...
    for node in mock_nodes:
        ...
        # Create the marker and its pop-up for each shop
        markers += "var {idd} = L.marker([{latitude}, {longitude}]);\
                    {idd}.addTo(map).bindPopup('{brand}<br><a href=\"{website}\">rezerwuj</a>');".format(idd=idd,
                                                                                                         latitude=node.lat,
                                                                                                         longitude=node.lon,
                                                                                                         brand=name,
                                                                                                         website=url_for(
    ...
    return render_template('/mapa.html', markers=markers, lat=request.form.get('lat'), lon=request.form.get('lon'),
                           date=date.strftime("%Y-%m-%d"), date_after_month=date_after_month.strftime("%Y-%m-%d"))
    # else:
